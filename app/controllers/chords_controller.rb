class ChordsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @chord.save
        format.html { redirect_to chords_path, notice: 'Chord was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @chord.update(chord_params)
        format.html { redirect_to chords_path, notice: 'Chord was successfully updated.' }
  ...
  def chord_params
    params.fetch(:chord, {}).permit(:pitch_id, :category, { piano_keys_groups_attributes: [:_destroy, :finger_left, :finger_right, :id, :piano_key_id, :pitch_id] })
  end
end
